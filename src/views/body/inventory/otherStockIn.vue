<template xmlns="">
  <div class="body">
    ...
    <div class="search">
      ...
      <el-select v-model="listPage.SendingAndReceivingID " size="small" style="width: 180px;" clearable
                 placeholder="请选择收发类别">
        <el-option
      ...
      allSave() {
        Dialog.confirm({
          ...
          message: '该操作将保存当前页的所有数据',
            ...
            .then(() => {
              let StkOtherStockInDetails = [];
              for (let item of this.list) {
                StkOtherStockInDetails.push({
              ...
              const param = {
                ...
                StkOtherStockInDetails
              };
              api.addstkotherstockin(this.$qs.stringify((param))).then(res => {
                if (res.data.Success) {

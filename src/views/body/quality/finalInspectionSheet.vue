    ...
    <van-pull-refresh
      ...
      <div class="content-item">
        <ul>
          ...
          <li>
            <ol v-for="(item,index) of list.FinalInspectionDetails">
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        api.getfinalinspectionitem(this.$qs.stringify(param)).then(res => {
          this.show = false;
          let data = res.data;
      ...
      handleSubmit() {
        ...
        this.list.SampleSize= this.list.SampleQuantity;
        this.list.QCFinalInspectionDetails = this.list.FinalInspectionDetails;
        delete this.list.BillNo;
        delete this.list.CheckQuantity;
        delete this.list.SampleQuantity;
        delete this.list.FinalInspectionDetails;
        Dialog.confirm({
          title: '提交',
          message: '该操作将保存当前页的所有数据',
            ...
            .then(() => {
              ...
              api.addqcfinalinspection(this.$qs.stringify((param))).then(res => {
                if (res.data.Success) {
